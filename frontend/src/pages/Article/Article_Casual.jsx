...
const Article_Casual = () => {

  return (
    <div className="container">
      <Navbar2_Components />

      <div className="art-casual">
        <section className="atcasual6">
          <div className="content-6">
            <img src="images/frame3.png" alt="photo1" />
          </div>
        </section>

        <div className="cards-section">
          <div className="art-compo1">
            <Article2_Components start={8} limit={1} />
          </div>
          <div className="art-compo2">
            <Article_Components start={9} limit={1} />
          </div>
          <div className="art-compo3">
            <Article2_Components start={10} limit={1} />
          </div>
        </div>

        <section className="atcasual7">
          <div className="line-with-text">
            <span>Latest</span>
          </div>
          <div className="art-compo4">
            <Article3_Components start={11} limit={5} />
          </div>
        </section>

        <section className="atcasual8">
          <h1>Outfit Recommendation</h1>
          <div className="fash-compo">
            <Fashion_Components limit={4} />
          </div>
        </section>

        <section className="atcasual9">
          <h1>You might like to visit</h1>
          <Place_Components start={5} limit={3} />
        </section>
      </div>
